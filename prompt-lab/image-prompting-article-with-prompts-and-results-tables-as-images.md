...
![Choose your starting point](table-images/01-choose-your-starting-point.png)
...
![Give complex images a structure](table-images/02-give-complex-images-a-structure.png)
...
![VELLUM: the visual inventory](table-images/03-vellum-the-visual-inventory.png)
...
![Know what your visual map contains](table-images/04-know-what-your-visual-map-contains.png)
...
![Three records, three jobs](table-images/05-three-records-three-jobs.png)
...
![VELLUM: reference and reconstruction](table-images/06-vellum-reference-and-reconstruction.png)
...
![Give every reference a job](table-images/07-give-every-reference-a-job.png)
...
![Comments, a map, or a sketch?](table-images/08-comments-a-map-or-a-sketch.png)
...
![What the prompting experiments showed](table-images/09-what-the-prompting-experiments-showed.png)
...
![SABLE: before and after repair](table-images/10-sable-before-and-after-repair.png)
...
![Match the repair to the failure](table-images/11-match-the-repair-to-the-failure.png)
...
![Test reference combinations with agents](table-images/12-test-reference-combinations-with-agents.png)
